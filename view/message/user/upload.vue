<template>
	<el-dialog class='upload' :title="pageTxt.lable[0]" width='600px' :visible.sync="imports">
		<!--<label class="txt">{{pageTxt.lable[4]}}</label>-->
...
import observer from '@/libs/observer.js';
	...
	var pageTxt_cn = {
		...
		lable: ['批量导入扩展信息','选取文件','上传到服务器','返回','批量导入路径：','在输入框中填入扩展信息文件名',
...
//      {name: 'food2.jpeg', url: 'https://fuss10.elemecdn.com/3/63/4e7f3a15429bfda99bce42a18cdd1jpeg.jpeg?imageMogr2/thumbnail/360x360/format/webp/quality/100'}],
	...
	export default {
		...
		methods: {
			submitUpload(){
				var _this = this;
//				utils.confirm({message:this.pageTxt.tips.sub, showCancelButton:true, callback:function(res,vm){
//					_this.imports = false;
